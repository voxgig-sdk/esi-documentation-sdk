...
// EsiDocumentation SDK utility type

class EsiDocumentationUtility
{
    ...
    public static function copy(EsiDocumentationUtility $src): EsiDocumentationUtility
    {
        $u = new EsiDocumentationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
