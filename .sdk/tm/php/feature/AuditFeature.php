...
// EsiDocumentation SDK audit feature
...
class EsiDocumentationAuditFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _emit(EsiDocumentationContext $ctx, string $outcome): void
    {
