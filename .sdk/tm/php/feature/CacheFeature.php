...
// EsiDocumentation SDK cache feature
...
class EsiDocumentationCacheFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _through(EsiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
