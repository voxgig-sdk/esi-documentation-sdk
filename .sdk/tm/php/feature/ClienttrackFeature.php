...
// EsiDocumentation SDK clienttrack feature
...
class EsiDocumentationClienttrackFeature extends EsiDocumentationBaseFeature
{
    ...
    public function PostConstruct(EsiDocumentationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EsiDocumentation-SDK';
