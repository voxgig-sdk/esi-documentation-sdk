...
// EsiDocumentation SDK netsim feature
...
class EsiDocumentationNetsimFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _simulate(EsiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EsiDocumentationContext $ctx, array $applied): void
    {
        $client = $this->client;
