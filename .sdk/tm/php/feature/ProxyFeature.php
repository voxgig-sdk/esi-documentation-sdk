...
// EsiDocumentation SDK proxy feature
...
class EsiDocumentationProxyFeature extends EsiDocumentationBaseFeature
{
    ...
    public function init(EsiDocumentationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EsiDocumentationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
