...
// EsiDocumentation SDK rbac feature
...
class EsiDocumentationRbacFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _required(EsiDocumentationContext $ctx): ?string
    {
    ...
    private function _reject(EsiDocumentationContext $ctx, string $required): void
    {
    ...
    private function _track(EsiDocumentationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
