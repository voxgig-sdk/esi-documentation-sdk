...
// EsiDocumentation SDK pipeline test
//
...
{
    private static function utility(): EsiDocumentationUtility
    {
        return new EsiDocumentationUtility();
    }
    ...
    private static function ctx(array $over = []): EsiDocumentationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EsiDocumentationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EsiDocumentationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EsiDocumentationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EsiDocumentationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EsiDocumentationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EsiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EsiDocumentationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EsiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EsiDocumentationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EsiDocumentationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EsiDocumentationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EsiDocumentationResponse([]),
            'result' => new EsiDocumentationResult([]),
        ]);
        [, $err] = EsiDocumentationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec([]),
            'response' => null,
            'result' => new EsiDocumentationResult([]),
        ]);
        [, $err] = EsiDocumentationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec(['step' => 's']),
            'response' => new EsiDocumentationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EsiDocumentationResult([]),
        ]);
        [, $err] = EsiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec(['step' => 's']),
            'response' => new EsiDocumentationResponse(self::resp(200, ['v' => 1])),
            'result' => new EsiDocumentationResult([]),
        ]);
        [, $err] = EsiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec(['step' => 's']),
            'response' => new EsiDocumentationResponse(self::resp(200, ['v' => 2])),
            'result' => new EsiDocumentationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EsiDocumentationMakeResponse::call($ctx);
    ...
    {
        $preset = new EsiDocumentationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec([]),
            'response' => new EsiDocumentationResponse([]),
            'result' => new EsiDocumentationResult([]),
        ...
        [$got, $err] = EsiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EsiDocumentationResult([])]);
        [, $err] = EsiDocumentationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EsiDocumentationSpec([]), 'result' => null]);
        [, $err] = EsiDocumentationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EsiDocumentationSpec(['step' => 's']),
            'result' => new EsiDocumentationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EsiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EsiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EsiDocumentationSpec(['step' => 's']),
            'result' => new EsiDocumentationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EsiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EsiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EsiDocumentationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EsiDocumentationSpec([]),
            'result' => new EsiDocumentationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EsiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EsiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EsiDocumentationError('boom', 'boom');
        $utility->fetcher = function (EsiDocumentationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EsiDocumentationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EsiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EsiDocumentationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EsiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EsiDocumentationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        EsiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EsiDocumentationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EsiDocumentationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EsiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EsiDocumentationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EsiDocumentationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EsiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EsiDocumentationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EsiDocumentationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EsiDocumentationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EsiDocumentationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EsiDocumentationResult(['ok' => false])]);
        $this->expectException(EsiDocumentationError::class);
        EsiDocumentationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EsiDocumentationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EsiDocumentationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EsiDocumentationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EsiDocumentationBaseFeature();
        $b = new EsiDocumentationBaseFeature();
        EsiDocumentationFeatureAdd::call($ctx, $a);
        EsiDocumentationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EsiDocumentationBaseFeature
    {
        $f = new EsiDocumentationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EsiDocumentationFeatureAdd::call($ctx, self::named_feature('a'));
        EsiDocumentationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        EsiDocumentationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        EsiDocumentationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        EsiDocumentationFeatureAdd::call($ctx, $replace);
        ...
        EsiDocumentationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EsiDocumentationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EsiDocumentationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EsiDocumentationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        EsiDocumentationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EsiDocumentationResponse(['headers' => null]),
            'result' => new EsiDocumentationResult([]),
        ]);
        EsiDocumentationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        EsiDocumentationResultBody::call($ctx);
