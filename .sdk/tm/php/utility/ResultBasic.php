...
// EsiDocumentation SDK utility: result_basic

class EsiDocumentationResultBasic
{
    public static function call(EsiDocumentationContext $ctx): ?EsiDocumentationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EsiDocumentationError) ? $result->err->msg : (string)$result->err;
