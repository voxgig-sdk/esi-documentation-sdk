...
// EsiDocumentation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EsiDocumentationTransformResponse
{
    public static function call(EsiDocumentationContext $ctx): mixed
    {
        ...
        $transform = EsiDocumentationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
