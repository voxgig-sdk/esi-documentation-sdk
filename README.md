...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/esi-documentation` | `npm install @voxgig-sdk/esi-documentation` |
| Python | `voxgig-sdk-esi-documentation` | `pip install voxgig-sdk-esi-documentation` |
| PHP | `voxgig-sdk/esi-documentation` | `composer require voxgig-sdk/esi-documentation` |
| Golang | `github.com/voxgig-sdk/esi-documentation-sdk/go` | `go get github.com/voxgig-sdk/esi-documentation-sdk/go` |
| Ruby | `voxgig-sdk-esi-documentation` | `gem install voxgig-sdk-esi-documentation` |
| Lua | `voxgig-sdk-esi-documentation` | `luarocks install voxgig-sdk-esi-documentation` |
