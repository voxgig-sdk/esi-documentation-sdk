...
AQL-driven CLI and REPL for the EsiDocumentation SDK. Positional arguments are
...
```sh
go build -o esi-documentation-cli ./...
```
...
./esi-documentation-cli load 1 asset
./esi-documentation-cli load '{id:1}' asset
