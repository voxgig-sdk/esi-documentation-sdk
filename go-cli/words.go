...
func registerSDKWords(r *eng.Registry, client *sdk.EsiDocumentationSDK) {
...
func runOp(client *sdk.EsiDocumentationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
