// Command EsiDocumentation-mcp is an MCP server exposing the EsiDocumentation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EsiDocumentation_list  — list records of an entity
//	EsiDocumentation_load  — load a single record of an entity
//
