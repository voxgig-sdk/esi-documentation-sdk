...
type Args struct {
	Entity string         `json:"entity" jsonschema:"asset | character | structure"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EsiDocumentationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "esi-documentation_list",
		Description: "List records from EsiDocumentation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "esi-documentation_load",
		Description: "Load a single record from EsiDocumentation. " +
...
func runOp(client *sdk.EsiDocumentationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EsiDocumentationSDK, name string) (sdk.EsiDocumentationEntity, error) {
	...
	case "structure":
		return client.Structure(nil), nil
