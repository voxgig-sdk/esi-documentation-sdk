# EsiDocumentation Golang SDK



The Golang SDK for the EsiDocumentation API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/esi-documentation-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/esi-documentation-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/esi-documentation-sdk/go=../esi-documentation-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EsiDocumentationSDK
```
...
### Entity interface (EsiDocumentationEntity)

All entities implement the `EsiDocumentationEntity` interface.
...
slice):
    ...
    asset, err := client.Asset(nil).List(map[string]any{/* fields */}, nil)
    if err != nil { /* handle */ }
...
Create an instance: `structure := client.Structure(nil)`
...
```
github.com/voxgig-sdk/esi-documentation-sdk/go/
├── esi-documentation.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/esi-documentation-sdk/go`) re-exports everything needed
