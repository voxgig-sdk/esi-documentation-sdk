...
The Golang SDK for the EsiDocumentation API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/esi-documentation-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/esi-documentation-sdk=../path/to/github.com/voxgig-sdk/esi-documentation-sdk
```
...
```
github.com/voxgig-sdk/esi-documentation-sdk/
...
The root package (`github.com/voxgig-sdk/esi-documentation-sdk`) re-exports everything needed
