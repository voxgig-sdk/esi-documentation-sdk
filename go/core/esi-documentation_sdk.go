...
type EsiDocumentationSDK struct {
	Mode     string
...
func (sdk *EsiDocumentationSDK) OptionsMap() map[string]any {
...
func (sdk *EsiDocumentationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EsiDocumentationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EsiDocumentationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EsiDocumentationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EsiDocumentationSDK {
	...
	sdk := NewEsiDocumentationSDK(sdkopts)
	sdk.Mode = "test"
