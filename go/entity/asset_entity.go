...
func NewAssetEntity(client *core.EsiDocumentationSDK, entopts map[string]any) *AssetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AssetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
