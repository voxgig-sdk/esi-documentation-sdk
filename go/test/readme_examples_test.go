...
const testSeed = `map[string]any{"entity": map[string]any{"asset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "structure": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
