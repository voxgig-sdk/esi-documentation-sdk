...
function StructureEntity.new(client, entopts)
  entopts = entopts or {}
...
function StructureEntity:get_name()
  return self._name
end


function StructureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StructureEntity.new(self._client, opts)
end


function StructureEntity:data_set(args)
  if args ~= nil then
...
function StructureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StructureEntity:match_set(args)
  if args ~= nil then
...
function StructureEntity:match_get()
...
function StructureEntity:stream(action, args, callopts)
...
function StructureEntity:_run_op(ctx, post_done)
  local utility = self._utility
