...
describe("AssetEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ESIDOCUMENTATION_TEST_ASSET_ENTID JSON to run live")
      return
    end
...
function asset_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ESIDOCUMENTATION_TEST_ASSET_ENTID")
