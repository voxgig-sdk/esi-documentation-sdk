...
function runner.env_override(m)
  local live = runner.getenv("ESIDOCUMENTATION_TEST_LIVE")
  local override = runner.getenv("ESIDOCUMENTATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ESIDOCUMENTATION_TEST_EXPLAIN")
