...
describe("StructureDirect", function()
  it("should direct-load-structure", function()
    local setup = structure_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-structure", setup.live and "live" or "unit")
...
function structure_direct_setup(mockres)
