...
class EsiDocumentationSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = EsiDocumentationHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = EsiDocumentationHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, EsiDocumentationFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return EsiDocumentationUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = EsiDocumentationHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = EsiDocumentationHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = EsiDocumentationHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = EsiDocumentationHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function Structure($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_structure === null) {
                $this->_structure = new StructureEntity($this, null);
            }
            return $this->_structure;
        }
        return new StructureEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new EsiDocumentationSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
