...
// EsiDocumentation SDK ratelimit feature
...
class EsiDocumentationRatelimitFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _acquire(EsiDocumentationContext $ctx): void
    {
    ...
    private function _track(EsiDocumentationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
