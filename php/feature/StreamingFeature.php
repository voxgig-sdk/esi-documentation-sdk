...
// EsiDocumentation SDK streaming feature
...
class EsiDocumentationStreamingFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _iterate(EsiDocumentationResult $result): \Generator
    {
    ...
    private function _streamable(EsiDocumentationContext $ctx): bool
    {
