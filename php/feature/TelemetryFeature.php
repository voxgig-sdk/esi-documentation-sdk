...
// EsiDocumentation SDK telemetry feature
...
class EsiDocumentationTelemetryFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _close(EsiDocumentationContext $ctx, bool $ok): void
    {
