...
// EsiDocumentation SDK timeout feature
...
class EsiDocumentationTimeoutFeature extends EsiDocumentationBaseFeature
{
    ...
    private function _with_timeout(EsiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EsiDocumentationContext $_ctx, float $ms): void
    {
        $client = $this->client;
