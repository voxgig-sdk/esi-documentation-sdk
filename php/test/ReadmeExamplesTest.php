...
// EsiDocumentation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EsiDocumentationSDK::test)
...
{
    private const SDK_CLASS = 'EsiDocumentationSDK';
    ...
    private const SDK_BASE = 'esidocumentation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../esidocumentation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
