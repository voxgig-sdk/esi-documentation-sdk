...
class StructureDirectTest extends TestCase
{
    public function test_direct_load_structure(): void
    {
        $setup = structure_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-structure", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
