...
// EsiDocumentation SDK utility: fetcher

class EsiDocumentationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EsiDocumentationSDK/1.0)';
    ...
    public static function call(EsiDocumentationContext $ctx, string $fullurl, array $fetchdef): array
    {
