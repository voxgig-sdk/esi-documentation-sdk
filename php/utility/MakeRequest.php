...
// EsiDocumentation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EsiDocumentationMakeRequest
{
    public static function call(EsiDocumentationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EsiDocumentationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EsiDocumentationResponse($fetched);
        } else {
