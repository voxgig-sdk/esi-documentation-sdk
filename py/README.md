...
The Python SDK for the EsiDocumentation API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/esi-documentation-sdk/releases)) or
