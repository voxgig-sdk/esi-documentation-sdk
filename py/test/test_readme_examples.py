# EsiDocumentation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EsiDocumentationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EsiDocumentationSDK(...) and EsiDocumentationSDK.test(...) become
#      EsiDocumentationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "esidocumentation_sdk"
_SDK_CLASS = "EsiDocumentationSDK"
