...
The Ruby SDK for the EsiDocumentation API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.EsiDocumentation(nil).load(
  { "id" => "test01" }, nil
)
