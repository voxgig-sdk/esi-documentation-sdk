...
class EsiDocumentationSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new EsiDocumentationSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return EsiDocumentationSDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'EsiDocumentation' }
  }

  toString() {
    return 'EsiDocumentation ' + this._utility.struct.jsonify(this.toJSON())
  }
