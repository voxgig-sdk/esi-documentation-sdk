...
describe('CharacterEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set ESI_DOCUMENTATION_TEST_CHARACTER_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['ESI_DOCUMENTATION_TEST_CHARACTER_ENTID']
